        ...
        return args -> {
            if (movieRepository.count() == 0) {
                movieRepository.saveAll(List.of(
                        Movie.builder()
                                .title("심연의 궤도")
                                .shortDescription("우주 관측 임무 중 발생한 신호 이상, 그리고 진실을 쫓는 마지막 72시간.")
                                .description("지구 저궤도 관측소에서 포착된 원인 불명의 신호. 임무 종료를 앞둔 팀 리더는 신호의 정체가 인류 생존과 연결되어 있음을 알게 되고, 제한된 시간 안에 선택을 내려야 한다.")
                                .genre("SF · 스릴러")
                                .ageRating("12")
                                .runningTime(132)
                        ...
                        Movie.builder()
                                .title("화이트 노이즈")
                                .shortDescription("도시를 뒤덮은 정체불명 전파, 단서를 좇는 추적 스릴러.")
                                .description("정체불명의 사건 이후 도시 전체가 혼란에 빠지고, 한 기자가 사건의 실체를 추적한다.")
                                .genre("스릴러 · 미스터리")
                                .ageRating("15")
                                .runningTime(118)
                        ...
                        Movie.builder()
                                ...
                                .description("도시 전체가 어둠에 잠긴 밤, 서로 다른 목적을 가진 인물들이 한 지점으로 모인다.")
                                .genre("액션 · 범죄")
                                .ageRating("15")
                                .runningTime(124)
                        ...
                        Movie.builder()
                                .title("심야의 항로")
                                .shortDescription("폭풍 전야의 바다에서 시작되는 미스터리 스릴러.")
                                .description("폭풍 전야의 바다 한가운데에서 구조 신호를 받은 선원들은 예상치 못한 사건과 마주한다.")
                                .genre("미스터리")
                                .ageRating("12")
                                .runningTime(121)
                        ...
                        Movie.builder()
                                .title("리버스 코드")
                                .shortDescription("시간을 거슬러 단서를 조합하는 SF 미스터리.")
                                .description("미완의 암호를 추적하던 개발자가 하루씩 되감기는 사건에 휘말린다.")
                                .genre("SF · 미스터리")
                                .ageRating("ALL")
                                .runningTime(116)
                        ...
                        Movie.builder()
                                .title("극야의 기록")
                                .shortDescription("끝나지 않는 밤 속에서 드러나는 진실.")
                                .description("극지 연구기지에서 사라진 기록을 둘러싼 심리 스릴러.")
                                .genre("스릴러")
                                .ageRating("19")
                                .runningTime(127)
                        ...
                        Movie.builder()
                                .title("폴라리스")
                                .shortDescription("잃어버린 좌표를 따라 떠나는 감성 모험극.")
                                .description("한 장의 지도와 오래된 무전기를 들고 떠나는 청춘 로드무비.")
                                .genre("드라마 · 어드벤처")
                                .ageRating("12")
                                .runningTime(111)
